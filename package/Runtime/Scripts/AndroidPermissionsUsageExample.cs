...
public class AndroidPermissionsUsageExample : MonoBehaviour
{
    ...
    private bool CheckPermissions()
    {
        ...
        return AndroidPermissionsManager.IsPermissionGranted(AndroidPermission.READ_EXTERNAL_STORAGE);
    }

    public void OnGrantButtonPress()
    {
        AndroidPermissionsManager.RequestPermissions(new []{AndroidPermission.READ_EXTERNAL_STORAGE}, new AndroidPermissionCallback(
            grantedPermission =>
            {
